<template>
    <q-layout view="lHr lpR fFf">
        ...
        <q-header bordered class="bg-white text-black">
            <q-toolbar>
                ...
                <q-toolbar-title class="text-weight-bold">
                    ...
                    <q-icon name="fas fa-dove" size="sm" color="primary" class="q-pa-md lt-md absolute-center"/>
                </q-toolbar-title>
        ...
        <q-drawer show-if-above v-model="leftDrawerOpen" :width="283" side="left" bordered>
            <!-- drawer content -->
            <q-icon name="fas fa-dove" size="lg" color="primary" class="q-ma-md"/>
            <div>
                <q-list>
        ...
        <q-drawer side="right" show-if-above v-model="leftDrawerOpen" bordered>
            <!-- drawer content -->
            <q-input rounded outlined class="q-ma-md" placeholder="Search">
